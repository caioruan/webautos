...
Class Opcional extends ModelOpcional {
    ...
    public function incluir() {
        ...
        $this->gravar();
        Router::redirect(Router::base() . "/opcional/grupo/$this->opcional_grupo/?cadastrado");
    }
    ...
    public function atualizar() {
        ...
        $this->opcional_grupo = intval($_POST['opcional_grupo']);
        $this->opcional_nome = $_POST['opcional_nome'];
        $this->gravar($this->opcional_id);
        Router::redirect(Router::base() . "/opcional/grupo/$this->opcional_grupo/?ok");
    }

    public function remover() {
        $this->opcional_id = intval(Router::getUri(2));
        $this->opcional_grupo = intval(Router::getUri(3));
        parent::remover();
        Router::redirect(Router::base() . "/opcional/grupo/$this->opcional_grupo/?removido");
    }
