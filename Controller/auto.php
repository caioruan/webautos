...
Class Auto extends ModelAuto {
    ...
    public function incluir() {
        ...
        $this->auto_versao = $_POST['auto_versao'];
    ...
    public function foto_destaque() {
            $this->foto_id =  intval($_POST['foto_id']);
            $this->foto_auto =  intval($_POST['foto_auto']);
            $sql = "UPDATE foto SET foto_pos = 999 WHERE foto_auto = $this->foto_auto";
            $this->db->query($sql);

            $sql = "UPDATE foto SET foto_pos = 0 WHERE foto_id = $this->foto_id";
            $this->db->query($sql);
