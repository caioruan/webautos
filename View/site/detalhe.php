        ...
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo Router::base(); ?>/">
                    <img src="<?php echo Router::base(); ?>/midias/agencia/<?php echo $dados['agencia'][0]->agencia_foto; ?>"
            ...
            <div class="row pagetitle">
                <div class="col-xs-12">
                    <h2 style="line-height: 1;">
                        <?php echo $dados['auto']->marca_nome; ?> - <?php echo $dados['auto']->modelo_nome; ?>
                        - <?php echo $dados['auto']->versao_nome; ?>
                        <?php if ($dados['auto']->auto_combustivel > 0): ?>
                            - <?php echo $dados['auto']->combustivel_nome; ?>
                        <?php endif; ?>
                        <?php if ($dados['auto']->auto_porta > 0): ?>
                            - <?php echo $dados['auto']->auto_porta; ?>P
                        <?php endif; ?>
                        <?php if ($dados['auto']->auto_cambio > 0): ?>
                            - <?php echo $dados['auto']->cambio_nome; ?>
                        <?php endif; ?>
                        - <?php echo $dados['auto']->auto_ano; ?>
                    </h2>
                </div>
            </div>
            <div class="row">
                            ...
                            <div id="carousel-car" class="carousel slide" data-ride="carousel">
                                ...
                                <ol class="carousel-indicators">
                                    <?php foreach ($dados['foto'] as $f) : ?>
                                        <?php if ($x == 0): ?>
                                            <li data-target="#carousel-car" data-slide-to="<?= $x ?>"
                                                class="active"></li>
                                        <?php else: ?>
                                ...
                                <div class="carousel-inner" role="listbox">
                                    <?php foreach ($dados['foto'] as $f) : ?>
                                        ...
                                        <?php endif; ?>
                                        <a class="fancybox" data-rel="gallery1"
                                           href="<?php echo Router::base(); ?>/midias/fotos/<?php echo $f->foto_url; ?>"
                                           title="<?php echo $dados['auto']->modelo_nome; ?> - <?php echo $dados['auto']->versao_nome; ?> - <?php echo $dados['auto']->auto_ano; ?>">
                                            <?php if ($f->foto_url != ""): ?>
                                                <img src="<?php echo Router::base(); ?>/midias/thumb.php?zc=1&w=560&h=450&src=fotos/<?php echo $f->foto_url; ?>"
                                                     alt="">
                                            <?php else : ?>
                                                <img src="<?php echo Router::base(); ?>/midias/thumb.php?zc=1&w=560&h=450&src=fotos/sem.png"
                                                     alt="sem foto" class="img-responsive"/>
                                            <?php endif; ?>
                                        </a>
                ...
                <div class="col-md-6">
                    <?php if ($dados['auto']->auto_preco != "") : ?>
                        <br>
                        <div class="tags price"><span></span> R$<?php echo Util::money($dados['auto']->auto_preco); ?>
                        </div>
                    <?php endif; ?>
                    <div class="row">
                    ...
                    <div class="row">
                        <form role="form" class="formcontact" method="post" enctype="multipart/form-data"
                              action="<?php echo Router::base(); ?>/detalhe/enviar/">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="mensagem" id="mesagem" class="form-control" rows="4"
                                          required></textarea>
                            </div>
                            <input type="hidden" name="auto_url"
                                   value="<?php echo Router::base(); ?>/detalhe/<?php echo Util::slug($dados['auto']->marca_nome); ?>/<?php echo Util::slug($dados['auto']->modelo_nome); ?>/ano-<?php echo Util::slug($dados['auto']->auto_ano); ?>/<?php echo Util::slug($dados['auto']->auto_id); ?>"/>
                            <input type="hidden" name="modelo"
                                   value="<?php echo Util::slug($dados['auto']->modelo_nome); ?> - ID: <?php echo Util::slug($dados['auto']->auto_id); ?>"/>
            ...
            <div class="row extrainfo">
                <div class="col-md-12">
                    ...
                    <div class="tab-content alt">
                        <b>Cor: </b> <?php echo $dados['auto']->cor_nome ?> <br/>
                        <b>Estado: </b> <?php echo $dados['auto']->auto_estado? "Novo":"Usado"; ?> <br/>
                        <b>Kilometragem: </b> <?php echo $dados['auto']->auto_km; ?> km<br>
                        <b>Tipo de Negociação: </b><?php echo $dados['auto']->auto_negociacao? "Aceita troca":"Não aceita troca"; ?><br>
                        <b>Documentação: </b> <?php echo $dados['auto']->documentacao_nome; ?><br>
                                                        ...
                                                        <?php if (is_array($opc_ids)): ?>
                                                            <?php if (in_array($item->opcional_id, $opc_ids)): ?>
                                                                <span class="list-group-item"><i
                                                                            class="icon-right-open"></i><?php echo $item->opcional_nome; ?></span>
                                                            <?php endif; ?>
                                                        <?php endif; ?>
                                                    <?php endforeach; ?>
                                                </div>
                        ...
                        <?php foreach ($dados['parceiro'] as $p) : ?>
                            ...
                            <div>
                                <a href="<?php echo $p->slide_link; ?>" target="_blank">
                                    <img src="<?php echo Router::base(); ?>/midias/thumb.php?zc=2&w=140&h=100&src=parceiro/<?php echo $p->slide_foto; ?>"
                                         alt="logo parceiro" class="img-responsive">
                                </a>
                            </div>
        ...
        <div class="container">
            <div class="row bread-top">
                <div class="col-xs-6 breadcrumbs">
                    Você está aqui: <a href="<?php echo Router::base(); ?>/">Detalhe
                        - <?php echo $dados['auto']->modelo_nome; ?></a>
                </div>
                ...
                <div class="col-xs-12 col-sm-5 col-md-5">
                    ...
                    <p>
                        <?php if ($dados['agencia'][0]->agencia_desc != ""): ?>
                            <?php echo Util::cut($dados['agencia'][0]->agencia_desc, 200, '...'); ?> <a
                                    href="<?php echo Router::Base(); ?>/sobre"><i>saiba mais</i></a>
                        <?php endif; ?>
                    </p>
                </div>
            </div>
...
<script>window.jQuery || document.write("<script src=\"js/jquery-1.9.1.min.js\"") < /script>
    < script
    src = "<?php echo Router::base(); ?>/View/site/js/respond.min.js" ></script>
