            ...
            <div class="container">
                <?php if (isset($dados['servico'][0])): ?>
                    <div class="row pagetitle">
                        <div class="col-xs-12">
                            <h2><?php echo $dados['servico'][0]->servico_nome; ?></h2>
                            <hr />
                        </div>
                    </div><br />
                    <div class="row itemde">
                        ...
                        <div class="col-md-10 team">
                            <p><?php echo $dados['servico'][0]->servico_desc; ?></p>
                        </div>
                    </div>
                <?php else : ?>
                ...
                <div class="container">
                    <div class="row bread-top">
                        <div class="col-xs-6 breadcrumbs">
                            Você está aqui: <a href="<?php echo Router::base(); ?>/servico/">Serviço - <?php echo $dados['servico'][0]->servico_nome; ?></a>
                        </div>
