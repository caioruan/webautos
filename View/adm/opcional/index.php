                                ...
                                <?php foreach ($dados['opc'] as $obj) : ?>
                                    <tr>
                                        ...
                                        <td class="text-center"> 
                                            ...
                                            <button data-link="<?php echo Router::base(); ?>/opcional/remover/<?php echo $obj->opcional_id; ?>/<?php echo $obj->opcional_grupo; ?>"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p>Você está prestes à remover um opcional e todos os iténs relacionados à ele!</p>
                    </div>
