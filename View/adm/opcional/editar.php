    ...
    <body>
        ...
        <div class="content-wrapper">
            <div class="container">
                ...
                <br /><br />
                <form method="post" enctype="multipart/form-data" action="<?php echo Router::base(); ?>/opcional/atualizar/">
                    <div class="row">
                        <div class="col-md-6">
                            <input type="hidden" name="opcional_grupo" id="opcional_grupo" value="<?php echo $dados['opcional']->opcional_grupo ?>" >
                            <input type="hidden" name="opcional_id" id="opcional_id" value="<?php echo $dados['opcional']->opcional_id ?>" >
                            <div class="form-group">
                                <input type="text" name="opcional_nome" id="opcional_nome" 
                                       placeholder="Informe opcional" class="form-control altura"
