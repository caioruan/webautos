    ...
    <body>
                ...
                <form method="post" enctype="multipart/form-data" action="<?php echo Router::base(); ?>/auto/atualizar/">
                        ...
                        <div class="form-group col-md-6 col-xs-12">
                            ...
                            <select name="auto_modelo" id="auto_modelo" class="form-control" required >
                                ...
                                <?php foreach ($dados['modelo'] as $mo): ?>
                                    <option <?= $dados['auto']->auto_modelo ==  $mo->modelo_id ? 'selected' : '' ?> value="<?php echo $mo->modelo_id ?>" data-marca="<?php echo $mo->modelo_marca; ?>"> <?php echo $mo->modelo_nome ?></option>
                                <?php endforeach; ?>                           
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="form-group col-md-4 col-xs-12">
                            ...
                            <input class="form-control" type="text" name="auto_versao" placeholder="Versão do automóvel" value="<?= $dados['auto']->auto_versao ?>">
                        </div>

                        <div class="form-group col-md-2 col-xs-12">
                            <label for="auto_versao">Placa</label>
                        ...
                        <div class="form-group col-md-2 col-xs-12">
                            ...
                            <select name="auto_placa" id="auto_placa" class="form-control">
                        ...
                        <div class="form-group col-md-2 col-xs-12">
                            ...
                            <select name="auto_estado" id="auto_estado" class="form-control" required>
                                ...
                                <option value="1" <?= $dados['auto']->auto_estado == '1' ? 'selected' : '' ?> >Novo</option>
                                <option value="0" <?= $dados['auto']->auto_estado == '0' ? 'selected' : '' ?> >Usado</option>
                            </select>
                        </div>
                        <div class="form-group col-md-2 col-xs-12">
                        ...
                        <div class="form-group col-md-2 col-xs-12">
                            ...
                            <select name="auto_cambio" id="auto_cambio" class="form-control" required >
                                ...
                                <?php foreach ($dados['cambio'] as $ca): ?>
                                    <option value="<?php echo $ca->cambio_id ?>" <?= $dados['auto']->auto_cambio == $ca->cambio_id ? 'selected' : '' ?> > <?php echo $ca->cambio_nome ?></option>
                                <?php endforeach; ?>                           
                            </select>
                        </div>
                        <div class="form-group col-md-2 col-xs-12">
                            ...
                            <select name="auto_cor" id="auto_cor" class="form-control" required >
                                ...
                                <?php foreach ($dados['cor'] as $co): ?>
                                    <option value="<?php echo $co->cor_id ?>" <?= $dados['auto']->auto_cor == $co->cor_id ? 'selected' : '' ?> > <?php echo $co->cor_nome ?></option>
                                <?php endforeach; ?>                           
                            </select>
                        </div>
                        <div class="form-group col-md-2 col-xs-12">
                            ...
                            <select name="auto_combustivel" id="auto_combustivel" class="form-control" required >
                                ...
                                <?php foreach ($dados['combustivel'] as $com): ?>
                                    <option value="<?php echo $com->combustivel_id ?>" <?= $dados['auto']->auto_combustivel == $com->combustivel_id ? 'selected' : '' ?> > <?php echo $com->combustivel_nome ?></option>
                                <?php endforeach; ?>                           
                            </select>
                        </div>
                        <div class="form-group col-md-2 col-xs-12">
                            ...
                            <select name="auto_carroceria" id="auto_carroceria" class="form-control" required >
                                ...
                                <?php foreach ($dados['carroceria'] as $car): ?>
                                    <option value="<?php echo $car->carroceria_id ?>" <?= $dados['auto']->auto_carroceria == $car->carroceria_id ? 'selected' : '' ?> > <?php echo $car->carroceria_nome ?></option>
                                <?php endforeach; ?>                           
                            </select>
                        </div>
                        <div class="form-group col-md-2 col-xs-12">
                            ...
                            <select name="auto_documentacao" id="auto_documentacao" class="form-control" required >
                                ...
                                <?php foreach ($dados['documentacao'] as $doc): ?>
                                    <option value="<?php echo $doc->documentacao_id ?>"  <?= $dados['auto']->auto_documentacao == $doc->documentacao_id ? 'selected' : '' ?> > <?php echo $doc->documentacao_nome ?></option>
                                <?php endforeach; ?>                           
                            </select>
                        </div>
                        <div class="form-group col-md-2 col-xs-12">
                            ...
                            <select name="auto_necessidade" id="auto_necessidade" class="form-control" required >
                                ...
                                <?php foreach ($dados['necessidade'] as $nec): ?>
                                    <option value="<?php echo $nec->necessidade_id ?>" <?= $dados['auto']->auto_necessidade == $nec->necessidade_id ? 'selected' : '' ?> > <?php echo $nec->necessidade_nome ?></option>
                                <?php endforeach; ?>                           
                            </select>
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-md-2 col-xs-12">
                            ...
                            <select name="auto_negociacao" id="auto_negociacao" class="form-control" >
                                ...
                                <option value="1" <?= $dados['auto']->auto_negociacao == '1' ? 'selected' : '' ?> >Aceita troca</option>
                                <option value="0" <?= $dados['auto']->auto_negociacao == '0' ? 'selected' : '' ?> >Não aceita troca</option>
                            </select>
                        </div>
                        <div class="form-group col-md-2 col-xs-12">
                            ...
                            <select name="auto_porta" id="auto_porta" class="form-control" >
                                ...
                                <option value="2" <?= $dados['auto']->auto_porta == '2' ? 'selected' : '' ?>>2</option>
                                <option value="3" <?= $dados['auto']->auto_porta == '3' ? 'selected' : '' ?>>3</option>
                                <option value="4" <?= $dados['auto']->auto_porta == '4' ? 'selected' : '' ?>>4</option>
                            </select>
                        </div>
                        ...
                        <div class="form-group col-md-2 col-xs-12">
                            ...
                            <input type="text" name="auto_preco" id="auto_preco" class="form-control altura money" placeholder="Informe o preço"
                    ...
                    <div class="form-group">
                        <label for="auto_obs">Observação</label>
        ...
        <script type="text/javascript">
           ...
           $("#auto_marca").val( '<?php echo $dados['auto']->auto_marca ?>').trigger('change');            
            ...
            $("#auto_versao").val('<?php echo $dados['auto']->auto_versao ?>');
            $("#auto_placa").val('<?php echo $dados['auto']->auto_placa ?>');
            $("#auto_ano").val('<?php echo $dados['auto']->auto_ano ?>');
            $("#auto_estado").val('<?php echo $dados['auto']->auto_estado ?>');
            $("#auto_negociacao").val('<?php echo $dados['auto']->auto_negociacao ?>');
            $("#auto_porta").val('<?php echo $dados['auto']->auto_porta ?>');
            $("#auto_destaque").val('<?php echo $dados['auto']->auto_destaque; ?>');
            $("#auto_oferta").val('<?php echo $dados['auto']->auto_oferta; ?>');
            $("#auto_cor").val('<?php echo $dados['auto']->auto_cor; ?>');
            $("#auto_cambio").val('<?php echo $dados['auto']->auto_cambio; ?>');
            $("#auto_combustivel").val('<?php echo $dados['auto']->auto_combustivel; ?>');
            $("#auto_carroceria").val('<?php echo $dados['auto']->auto_carroceria; ?>');
            $("#auto_documentacao").val('<?php echo $dados['auto']->auto_documentacao; ?>');
            $("#auto_necessidade").val('<?php echo $dados['auto']->auto_necessidade; ?>');
        </script>
